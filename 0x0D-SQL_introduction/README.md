...
The project It aims to learn about databases, relational databases, subqueries, tables, MySQL statements and functions.
...
This repository contains all of the following files, which are MySQL scripts:
